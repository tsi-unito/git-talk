...
Il workshop è gratuito e non richiede alcun pagamento. Tuttavia, è necessario registrarsi in anticipo per garantire un posto in presenza. Per registrarsi, è sufficiente compilare il modulo di registrazione disponibile al seguente link: [Registrazione](https://app.hi.events/event/826/workshop-git-e-github).
